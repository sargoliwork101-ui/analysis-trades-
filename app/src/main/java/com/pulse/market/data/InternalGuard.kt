 ...
 *
 * مسئله‌ی امنیتی: در نسخه‌های قدیمی رسیورهای ویجت exported بودند و هر برنامه‌ی دیگری روی گوشی
 * می‌توانست اکشن‌های
 ...
 * اکنون رسیورها نیز مطابق راهنمای Android غیرexported هستند؛ توکن یک لایه‌ی
 * دفاعی دوم برای PendingIntentهای داخلی است. پیام‌های سیستمی دست‌نخورده کار می‌کنند.
 * ─────────────────────────────────────────────────────────────────────────
 */
